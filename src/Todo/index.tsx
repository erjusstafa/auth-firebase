...
import { State } from "../redux/actions/Todo/type";
import "./index.css";
...
const Data = function () {
  ...
  console.log("sel", selectedTaskId);
  ...
  const handleUpdate = (e: FormEvent<HTMLFormElement>): void => {
    ...
    dispatch(editTaskActionCreator({ id: selectedTaskId, description: editTaskInput }));
    handleCancelUpdate();
  };
    ...
    <div className="App">
      ...
      <div className="App__header">
        ...
        <form onSubmit={handleCreateNewTodo}>
          ...
          <input placeholder="Enter your task" onChange={handleNewInputChange} id="new-todo" value={newTaskInput} />
      ...
      <div className="App__body">
        ...
        <ul className="App__list">
          ...
          {tasks.map((task, i) => (
            <li
              className={`${task.isComplete ? "done" : ""} ${task.id === selectedTaskId ? "active" : ""}`}
              key={task.id}
        ...
        <div className="App_todo-info">
          ...
          {selectedTask === null ? (
            ...
            <>
              <span className={`todo-desc ${selectedTask?.isComplete ? "done" : ""}`}>{selectedTask.description}</span>
            ...
            <form onSubmit={handleUpdate}>
              ...
              <input ref={editInput} onChange={handleEditInputChange} value={editTaskInput} />
